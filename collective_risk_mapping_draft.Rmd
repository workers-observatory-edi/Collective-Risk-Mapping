...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Discussion of the paper map and main mapping categories: what is most important to map? What are the main dangers? What mapping information would be useful for organising?
    \end{itemize}
  \item Break (15 min)
